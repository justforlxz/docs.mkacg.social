...
如果将要发送的消息内容存在争议，请明确标注；如果内容确实来源于可信平台，请附上来源链接的网站备份，以便其它用户参考查阅。
...
萌控二次元不认同**公开发布**未持有分享授权的资源行为，如因此产生的任何纠纷均由用户本人承担，与萌控二次元无关。
...
3. 您新的联系方式。
   ...
   该联系方式可以是 matrix 账号，或是 fediverse 账号。我们不推荐使用电子邮箱（因为萌控二次元运行的电子邮箱服务是只收不发的），也不推荐任何中心化的通信服务（隐私相关的考虑）。
